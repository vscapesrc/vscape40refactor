...
public final class ResourceProvider extends Provider implements Runnable {
   ...
   private void respond() {
      try {
         ...
         if(this.remainingData > 0 && var1 >= this.remainingData) {
            ...
            for(length = 0; length < this.remainingData; length += this.inputStream.read(var11, length + file, this.remainingData - length)) {
               ;
            }
   ...
   public final void provide(int type, int file) {
      ...
      synchronized(this.requests) {
         Resource node;
         for(node = (Resource)this.requests.reverseGetFirst(); node != null; node = (Resource)this.requests.reverseGetNext()) {
      ...
      try {
         while(this.running) {
            ...
            for(int var14 = 0; var14 < 100 && this.expectingData; ++var14) {
               ...
               for(var4 = (Resource)this.requested.getBack(); var4 != null; var4 = (Resource)var2.requested.getPrevious()) {
                  if(var4.mandatory) {
                     ++var2.A;
                     System.out.println("Error: model is incomplete or missing  [ type = " + var4.type + "]  [id = " + var4.file + "]");
                  } else {
                     ++var2.B;
                  }
               }
               ...
               while(var2.A < 10) {
                  try {
                     ...
                     var2.a(var4);
                     var2.expectingData = true;
                     System.out.println("Error: file is missing  [ type = " + var4.type + "]  [id = " + var4.file + "]");
            ...
            Resource var16;
            for(var16 = (Resource)this.requested.getBack(); var16 != null; var16 = (Resource)this.requested.getPrevious()) {
               if(var16.mandatory) {
                  var15 = true;
                  ++var16.age;
                  if(var16.age > 50) {
            ...
            if(this.client.loggedIn && this.socket != null && this.outputStream != null && (this.maximumPriority > 0 || this.client.indices[0] == null)) {
               ++this.d;
               if(this.d > 500) {
                  this.d = 0;
                  this.payload[0] = 0;
