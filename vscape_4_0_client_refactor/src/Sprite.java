...
public final class Sprite extends Rasterizer2D {
			...
			for (int var12 = -var3; var12 < 0; ++var12) {
				for (int var13 = -var2; var13 < 0; ++var13) {
					...
					if ((var3 = var18[var8++]) != 0) {
						...
						var19[var6++] = ((var3 & 16711935) * var7 + (var15 & 16711935) * var14 & -16711936)
								+ ((var3 & '\uff00') * var7 + (var15 & '\uff00') * var14 & 16711680) >> 8;
					} else {
						++var6;
					}
				}
			...
			for (int var10 = -var5; var10 < 0; ++var10) {
				for (int var11 = -var2; var11 < 0; ++var11) {
					...
					if ((var13 = var17[var7++]) != 0 && var13 != 16777215) {
						...
						var16[var6++] = ((var13 & 16711935) * var3 + (var14 & 16711935) * var12 & -16711936)
								+ ((var13 & '\uff00') * var3 + (var14 & '\uff00') * var12 & 16711680) >> 8;
					} else {
						++var6;
					}
				}
	...
	private void d(int var1, int var2, int var3) {
		for (var1 = 0; var1 < this.pixels.length; ++var1) {
			if ((this.pixels[var1] >> 16 & 255) == 255 && (this.pixels[var1] >> 8 & 255) == 0
					&& (this.pixels[var1] & 255) == 255) {
				this.pixels[var1] = 0;
			}
		}
	...
	public final void resize() {
		...
		for (int var2 = 0; var2 < this.height; ++var2) {
			System.arraycopy(this.pixels, var2 * this.width, var1,
					var2 + this.verticalOffset * this.resizeWidth + this.horizonalOffset, this.width);
		}
		...
		for (var7 = 0; var7 < var4; ++var7) {
			for (var8 = 0; var8 < var5; ++var8) {
				if (var6[var7 + var8 * var4] == 0) {
					if (var7 < var4 - 1 && var6[var7 + 1 + var8 * var4] > 0
							&& var6[var7 + 1 + var8 * var4] != 16777215) {
					...
					if (var8 < var5 - 1 && var6[var7 + (var8 + 1) * var4] > 0
							&& var6[var7 + (var8 + 1) * var4] != 16777215) {
						var6[var7 + var8 * var4] = var3;
					}
	...
	private static void draw(int[] raster, int[] image, int imagePosition, int rasterPosition, int width, int height,
			int rasterOffset, int var7) {
		int var8 = -(width >> 2);
		width = -(width & 3);
	...
	private static void a(int var0, int var1, int[] var2, int[] var3, int var4, int var5, int var6, int var7,
		...
		for (int var10 = -var5; var10 < 0; ++var10) {
			for (int var11 = -var1; var11 < 0; ++var11) {
				if ((var5 = var3[var0++]) != 0) {
					int var12 = var2[var8];
					var2[var8++] = ((var5 & 16711935) * var7 + (var12 & 16711935) * var9 & -16711936)
							+ ((var5 & '\uff00') * var7 + (var12 & '\uff00') * var9 & 16711680) >> 8;
				} else {
					++var8;
				}
			}
	...
	public final void drawSpriteRotated(int var1, int rotationAngle, int[] var3, int var4, int[] var5, int var6,
