	...
	public final void updatePlayer(Buffer var1) {
		...
		for (var2 = 0; var2 < 12; ++var2) {
			if ((var3 = var1.readUByte()) == 0) {
				...
				if (this.appearance[var2] >= 512 && this.appearance[var2] - 512 < ItemDefinition.count
						&& (var3 = ItemDefinition.fromID(this.appearance[var2] - 512).team) != 0) {
					this.ao = var3;
				}
			}
		}
		...
		this.name = StringUtils.formatName(StringUtils.longToName(var1.readLong()));
