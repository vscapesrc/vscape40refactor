final class MapRegion {
			...
			for (z = 0; z < 4; ++z) {
				...
				for (var9 = 1; var9 < 103; ++var9) {
					for (var10 = 1; var10 < 103; ++var10) {
						...
						y = (var29[var10 - 1][var9] >> 2) + (var29[var10 + 1][var9] >> 3)
								+ (var29[var10][var9 - 1] >> 2) + (var29[var10][var9 + 1] >> 3)
								+ (var29[var10][var9] >> 1);
				...
				for (var9 = -5; var9 < 109; ++var9) {
					for (var10 = 0; var10 < 104; ++var10) {
						if ((var11 = var9 + 5) >= 0 && var11 < 104
								&& (id = this.underlays[z][var11][var10] & 255) > 0) {
					...
					if (var9 > 0 && var9 < 103) {
						...
						for (var14 = -5; var14 < 109; ++var14) {
							...
							if (var14 > 0 && var14 < 103
									&& (!lowMemory || (this.tileFlags[0][var9][var14] & 2) != 0
											|| (this.tileFlags[z][var9][var14] & 16) == 0
													&& this.getCollisionPlane(var14, z, var9) == currentPlane)) {
								if (z < maximumPlane) {
									maximumPlane = z;
								}
								...
								if (y > 0 || var27 > 0) {
									...
									if (var27 == 0) {
										scene.a(z, var9, var14, 0, 0, -1, x, plane, var16, var8, light(var20, var15),
												light(var20, var17), light(var20, var18), light(var20, var19), 0, 0, 0,
												0, var22, 0);
									} else {
										...
										if (var27 - 1 != 54) {
											...
											scene.a(z, var9, var14, var21, var34, var24, x, plane, var16, var8,
													light(var20, var15), light(var20, var17), light(var20, var18),
													light(var20, var19), checkedLight(var25, var15),
													checkedLight(var25, var17), checkedLight(var25, var18),
													checkedLight(var25, var19), var22, y);
										}
									}
								}
							}
						...
						for (var16 = 0; var16 <= 104; ++var16) {
							if ((this.l[var27][var16][var28] & z) != 0) {
								...
								if ((var10 + 1 - var9) * (var8 - id + 1) >= 8) {
									...
									SceneGraph.a(plane, var16 << 7, var13, var16 << 7, (var8 << 7) + 128, var12,
											id << 7, 1);
							...
							if ((this.l[var27][var16][var28] & x) != 0) {
								...
								if ((var10 + 1 - var9) * (var8 - id + 1) >= 8) {
									...
									SceneGraph.a(plane, id << 7, var13, (var8 << 7) + 128, var28 << 7, var12,
											var28 << 7, 2);
							...
							if ((this.l[var27][var16][var28] & y) != 0) {
								...
								if ((var8 - id + 1) * (var10 - var9 + 1) >= 4) {
									...
									SceneGraph.a(plane, id << 7, var11, (var8 << 7) + 128, (var10 << 7) + 128, var11,
											var9 << 7, 4);
		...
		if (type == 22) {
			if (!lowMemory || definition.interactive || definition.obstructsGround) {
				if (definition.animation == -1 && definition.morphisms == null) {
					...
					object = new RenderableObject(id, orientation, 22, east, northEast, centre, north,
							definition.animation, true);
				}
			...
			if (type != 10 && type != 11) {
				if (type >= 12) {
					if (definition.animation == -1 && definition.morphisms == null) {
						...
						object = new RenderableObject(id, orientation, type, east, northEast, centre, north,
								definition.animation, true);
					}
					...
					if (definition.animation == -1 && definition.morphisms == null) {
						...
						object = new RenderableObject(id, orientation, 0, east, northEast, centre, north,
								definition.animation, true);
					}

					scene.addWall(anIntArray[orientation], (Renderable) object, key, y, config, x, (Renderable) null,
							mean, 0, z);
					if (orientation == 0) {
					...
					if (definition.animation == -1 && definition.morphisms == null) {
						...
						object = new RenderableObject(id, orientation, 1, east, northEast, centre, north,
								definition.animation, true);
					}

					scene.addWall(p[orientation], (Renderable) object, key, y, config, x, (Renderable) null, mean, 0,
							z);
					if (definition.castsShadow) {
						if (orientation == 0) {
							this.shading[z][x][y + 1] = 50;
					...
					if (type == 2) {
						...
						if (definition.animation == -1 && definition.morphisms == null) {
							...
							var22 = new RenderableObject(id, orientation + 4, 2, east, northEast, centre, north,
									definition.animation, true);
							var20 = new RenderableObject(id, displacement, 2, east, northEast, centre, north,
									definition.animation, true);
						}

						scene.addWall(anIntArray[orientation], (Renderable) var22, key, y, config, x,
								(Renderable) var20, mean, anIntArray[displacement], z);
						if (definition.occludes) {
							if (orientation == 0) {
								this.l[z][x][y] |= 585;
								this.l[z][x][y + 1] |= 1170;
						...
						if (definition.animation == -1 && definition.morphisms == null) {
							...
							object = new RenderableObject(id, orientation, 3, east, northEast, centre, north,
									definition.animation, true);
						}

						scene.addWall(p[orientation], (Renderable) object, key, y, config, x, (Renderable) null, mean,
								0, z);
						if (definition.castsShadow) {
							if (orientation == 0) {
								this.shading[z][x][y + 1] = 50;
						...
						scene.addObject(key, config, mean, 1, (Renderable) object, 1, z, 0, y, x);
						if (definition.solid && map != null) {
							map.flagObject(definition.impenetrable, definition.width, definition.length, x, y,
									orientation);
						}
						...
						if (type == 4) {
							if (definition.animation == -1 && definition.morphisms == null) {
								...
								object = new RenderableObject(id, 0, 4, east, northEast, centre, north,
										definition.animation, true);
							}

							scene.addWallDecoration(key, y, orientation << 9, z, 0, mean, (Renderable) object, x,
									config, 0, anIntArray[orientation]);
						} else if (type == 5) {
							displacement = 16;
							...
							if (definition.animation == -1 && definition.morphisms == null) {
								...
								var20 = new RenderableObject(id, 0, 4, east, northEast, centre, north,
										definition.animation, true);
							}

							scene.addWallDecoration(key, y, orientation << 9, z,
									COSINE_VERTICES[orientation] * displacement, mean, (Renderable) var20, x, config,
									SINE_VERTICES[orientation] * displacement, anIntArray[orientation]);
						} else if (type == 6) {
							if (definition.animation == -1 && definition.morphisms == null) {
								object = definition.modelAt(4, 0, centre, east, northEast, north, -1);
							} else {
							...
							scene.addWallDecoration(key, y, orientation, z, 0, mean, (Renderable) object, x, config, 0,
									256);
						} else if (type == 7) {
							if (definition.animation == -1 && definition.morphisms == null) {
								object = definition.modelAt(4, 0, centre, east, northEast, north, -1);
							...
							if (type == 8) {
								...
								scene.addWallDecoration(key, y, orientation, z, 0, mean, (Renderable) object, x, config,
										0, 768);
							}
				...
				if (definition.animation == -1 && definition.morphisms == null) {
					...
					object = new RenderableObject(id, orientation, 10, east, northEast, centre, north,
							definition.animation, true);
				}
				...
				if (object != null) {
					...
					if (scene.addObject(key, config, mean, type, (Renderable) object, id, z, existing, y, x)
	...
	public final void decodeConstructedMapData(int var1, int var2, CollisionMap[] maps, int topLeftRegionX, int var5,
			byte[] var6, int var7, int tileZ, int topLeftRegionY) {
		int y;
		for (int x = 0; x < 8; ++x) {
			for (y = 0; y < 8; ++y) {
				if (topLeftRegionX + x > 0 && topLeftRegionX + x < 103 && topLeftRegionY + y > 0
						&& topLeftRegionY + y < 103) {
			...
			for (int var15 = 0; var15 < 64; ++var15) {
				for (int var16 = 0; var16 < 64; ++var16) {
					if (y == var1 && var15 >= var5 && var15 < var5 + 8 && var16 >= var7 && var16 < var7 + 8) {
						...
						int var14 = var10002;
						int var13;
						int var10001 = topLeftRegionY + ((var13 = var2 & 3) == 0 ? var14
								: (var13 == 1 ? 7 - var12 : (var13 == 2 ? 7 - var14 : var12)));
						int var10006 = var16 & 7;
						var12 = var15 & 7;
						var13 = var10006;
						this.decodeMapData(var10001, 0, var17, topLeftRegionX + ((var14 = var2 & 3) == 0 ? var12
								: (var14 == 1 ? var13 : (var14 == 2 ? 7 - var12 : 7 - var13))), tileZ, var2, 0);
					} else {
		...
		try {
			...
			if (x >= 0 && x < 104 && y >= 0 && y < 104) {
				...
				if (z == 0) {
					...
					regionY += y + 556238;
					y = var10002;
					if ((y = (int) ((double) (interpolatedNoise(var10002 + '넵', regionY + 91923, 4) - 128
							+ (interpolatedNoise(y + 10294, regionY + '鎽', 2) - 128 >> 1)
							+ (interpolatedNoise(y, regionY, 1) - 128 >> 2)) * 0.3D) + 35) < 10) {
						y = 10;
					} else if (y > 60) {
						y = 60;
					}
	...
	public final void decodeConstructedLandscapes(CollisionMap[] maps, SceneGraph scene, int var3, int var4, int var5,
			int var6, byte[] var7, int var8, int var9, int var10) {
		...
		while ((idOffset = buffer.c()) != 0) {
			...
			while ((offset = buffer.s()) != 0) {
				...
				if (objectPlane == var3 && y >= var8 && y < var8 + 8 && offset >= var5 && offset < var5 + 8) {
					...
					int var23;
					int var24 = var4 + ((var23 = var9 & 3) == 0 ? var21
							: (var23 == 1 ? var20 : (var23 == 2 ? 7 - var21 - (var19 - 1) : 7 - var20 - (var22 - 1))));
					int var10001 = offset & 7;
					var19 = y & 7;
					var20 = definition.width;
					var22 = definition.length;
					var23 = var10001;
					offset = var10 + ((var21 = var9 & 3) == 0 ? var23
							: (var21 == 1 ? 7 - var19 - (var20 - 1) : (var21 == 2 ? 7 - var23 - (var22 - 1) : var19)));
	...
	private static int smoothNoise(int var0, int var1) {
		int var2 = perlinNoise(var0 - 1, var1 - 1) + perlinNoise(var0 + 1, var1 - 1) + perlinNoise(var0 - 1, var1 + 1)
				+ perlinNoise(var0 + 1, var1 + 1);
		int var3 = perlinNoise(var0 - 1, var1) + perlinNoise(var0 + 1, var1) + perlinNoise(var0, var1 - 1)
				+ perlinNoise(var0, var1 + 1);
	...
	public static void placeObject(SceneGraph var0, int var1, int y, int var3, int z, CollisionMap var5, int[][][] var6,
			int x, int id, int var9) {
		int aY = var6[z][x][y];
		int bY = var6[z][x + 1][y];
		...
		if (var3 == 22) {
			...
			if (var3 != 10 && var3 != 11) {
				if (var3 >= 12) {
					...
					var0.addWall(anIntArray[var1], (Renderable) var16, key, y, config, x, (Renderable) null, meanY, 0,
							var9);
					if (definition.solid) {
					...
					if (var3 == 2) {
						...
						var0.addWall(anIntArray[var1], (Renderable) var21, key, y, config, x, (Renderable) var19, meanY,
								anIntArray[var20], var9);
						if (definition.solid) {
							var5.flagObject(y, var1, x, var3, definition.impenetrable);
						}
						...
						if (var3 == 4) {
							...
							var0.addWallDecoration(key, y, var1 << 9, var9, 0, meanY, (Renderable) var16, x, config, 0,
									anIntArray[var1]);
						} else if (var3 == 5) {
							var20 = 16;
							...
							var0.addWallDecoration(key, y, var1 << 9, var9, COSINE_VERTICES[var1] * var20, meanY,
									(Renderable) var19, x, config, SINE_VERTICES[var1] * var20, anIntArray[var1]);
						} else if (var3 == 6) {
							if (definition.animation == -1 && definition.morphisms == null) {
								var16 = definition.modelAt(4, 0, aY, bY, cY, z, -1);
							} else {
							...
							if (var3 == 8) {
								...
								var0.addWallDecoration(key, y, var1, var9, 0, meanY, (Renderable) var16, x, config, 0,
										768);
							}
	...
	public static boolean objectsReady(int y, byte[] data, int x) {
		...
		int position;
		label62: while ((position = var10.s()) != 0) {
			var4 += position;
			position = 0;
			boolean var6 = false;
