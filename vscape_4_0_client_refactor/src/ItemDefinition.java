...
private void reset() {
   ...
   public static Sprite sprite(int id, int stackSize, int backColor) {
      if(backColor == 0) {
         Sprite var3;
         if((var3 = (Sprite)sprites.get((long)id)) != null && var3.resizeHeight != stackSize && var3.resizeHeight != -1) {
            var3.unlink();
            var3 = null;
         }
      ...
      if((model = definition.getAmountModel(1)) == null) {
         ...
         if(definition.notedTemplateId != -1 && (notedSprite = sprite(definition.noteInfoId, 10, -1)) == null) {
            ...
            model.render(definition.spriteCameraRoll, definition.spriteCameraYaw, definition.spritePitch, definition.spriteTranslateX, sin + model.modelHeight / 2 + definition.spriteTranslateY, scale + definition.spriteTranslateY);
            ...
            if(backColor > 0) {
               ...
               for(var4 = 31; var4 >= 0; --var4) {
                  for(scale = 31; scale >= 0; --scale) {
                     if(var6.pixels[var4 + (scale << 5)] == 0 && var4 > 0 && scale > 0 && var6.pixels[var4 - 1 + (scale - 1 << 5)] > 0) {
