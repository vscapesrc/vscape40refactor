final class StringUtils {
	private static final char[] a = new char[] { ' ', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm',
	...
	public static long nameToLong(String name) {
		...
		for (int var3 = 0; var3 < name.length() && var3 < 12; ++var3) {
			char var4 = name.charAt(var3);
			var1 *= 38L;
			if (var4 >= 65 && var4 <= 90) {
				var1 += (long) (var4 + 1 - 65);
	...
	public static String formatName(String var0) {
		if (var0.length() <= 0) {
			...
			for (int var1 = 0; var1 < var2.length; ++var1) {
				if ((var2[var1] == 95 || var2[var1] == 32) && var1 + 1 < var2.length && var2[var1 + 1] >= 97
						&& var2[var1 + 1] <= 122) {
