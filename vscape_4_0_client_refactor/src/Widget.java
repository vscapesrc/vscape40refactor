		...
		while (true) {
			...
			do {
				...
				if (buffer.position >= buffer.buf.length) {
					...
					var14.height = 35;
					int[] var15 = new int[] { 8654, 8655, 8656, 8657, 8658, 8659, 8660, 8661, 8662, 8663, 8664, 8665,
							8666, 8667, 8668, 8669, 8670, 8671, 8672, 12162, 13928 };
					int[][] var16 = new int[][] { { 4, 4 }, { 66, 4 }, { 128, 4 }, { 4, 34 }, { 66, 34 }, { 128, 34 },
							{ 4, 64 }, { 66, 64 }, { 128, 64 }, { 4, 94 }, { 66, 94 }, { 128, 94 }, { 4, 124 },
							{ 66, 124 }, { 128, 124 }, { 4, 154 }, { 66, 154 }, { 128, 154 }, { 4, 184 }, { 66, 184 },
							{ 128, 184 } };
					Widget var24;
					...
					for (var4 = 0; var4 < 20; ++var4) {
						if (buffer.readUByte() == 1) {
							...
							if (graphics != null && var21.length() > 0) {
								...
								var5.sprite[var4] = a(Integer.parseInt(var21.substring(var6 + 1)), graphics,
										var21.substring(0, var6));
							}
						}
					}
				...
				if (var5.group == 5) {
					...
					if (graphics != null && var22.length() > 0) {
						...
						var5.defaultSprite = a(Integer.parseInt(var22.substring(var7 + 1)), graphics,
								var22.substring(0, var7));
					}

					var22 = buffer.readString();
					if (graphics != null && var22.length() > 0) {
						var7 = var22.lastIndexOf(",");
						var5.secondarySprite = a(Integer.parseInt(var22.substring(var7 + 1)), graphics,
								var22.substring(0, var7));
					}
				}
