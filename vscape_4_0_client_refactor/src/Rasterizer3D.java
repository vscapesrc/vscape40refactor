final class Rasterizer3D extends Rasterizer2D {
	...
	public static void drawShadedTriangle(int var0, int var1, int var2, int var3, int var4, int var5, int var6,
			int var7, int var8) {
		var2 = var2;
		var1 = var1;
		var0 = var0;
						...
						while (true) {
							...
							if (var1 < 0) {
								while (true) {
									...
									drawShadedLine(Rasterizer2D.pixels, var0, var5 >> 16, var4 >> 16, var8 >> 7,
											var7 >> 7);
									var5 += var13;
									var4 += var11;
									var8 += var14;
						...
						while (true) {
							...
							if (var2 < 0) {
								while (true) {
									...
									drawShadedLine(Rasterizer2D.pixels, var1, var3 >> 16, var5 >> 16, var6 >> 7,
											var8 >> 7);
									var3 += var9;
									var5 += var13;
									var6 += var10;
				...
				while (true) {
					...
					if (var7 < 0) {
						if ((var7 = var3 - var2 & 3) > 0) {
							var5 = (((var5 = rgbTable[var4 >> 8]) & 16711935) * var9 >> 8 & 16711935)
									+ ((var5 & '\uff00') * var9 >> 8 & '\uff00');

							do {
								var0[var1++] = var5 + ((var0[var1] & 16711935) * var8 >> 8 & 16711935)
										+ ((var0[var1] & '\uff00') * var8 >> 8 & '\uff00');
								--var7;
							} while (var7 > 0);
						}
				...
				while (true) {
					...
					if (var5 < 0) {
						...
						while (true) {
							...
							var0[var1++] = var2 + ((var0[var1] & 16711935) * var6 >> 8 & 16711935)
									+ ((var0[var1] & '\uff00') * var6 >> 8 & '\uff00');
						}
					}
	...
	public static void drawTexturedTriangle(int var0, int var1, int var2, int var3, int var4, int var5, int var6,
		...
		if (var0 <= var1 && var0 <= var2) {
			if (var0 < Rasterizer2D.clipTop) {
						...
						while (true) {
							...
							if (var1 < 0) {
								while (true) {
									...
									drawTexuredLine(Rasterizer2D.pixels, var26, var0, var4 >> 16, var5 >> 16, var7 >> 8,
											var8 >> 8, var18, var22, var15, var28, var12, var13);
									var5 += var23;
									var4 += var16;
									var8 += var24;
									var7 += var17;
							...
							drawTexuredLine(Rasterizer2D.pixels, var26, var0, var3 >> 16, var5 >> 16, var6 >> 8,
									var8 >> 8, var18, var22, var15, var28, var12, var13);
							var5 += var23;
							var3 += var11;
							var8 += var24;
					...
					while (true) {
						...
						if (var1 < 0) {
							while (true) {
								...
								drawTexuredLine(Rasterizer2D.pixels, var26, var0, var5 >> 16, var4 >> 16, var8 >> 8,
										var7 >> 8, var18, var22, var15, var28, var12, var13);
								var5 += var23;
								var4 += var16;
								var8 += var24;
								var7 += var17;
						...
						drawTexuredLine(Rasterizer2D.pixels, var26, var0, var5 >> 16, var3 >> 16, var8 >> 8, var6 >> 8,
								var18, var22, var15, var28, var12, var13);
						var5 += var23;
						var3 += var11;
						var8 += var24;
						var6 += var14;
					...
					while (true) {
						...
						if (var2 < 0) {
							while (true) {
								...
								drawTexuredLine(Rasterizer2D.pixels, var26, var0, var5 >> 16, var3 >> 16, var8 >> 8,
										var6 >> 8, var18, var22, var15, var28, var12, var13);
								var5 += var16;
								var3 += var11;
								var8 += var17;
								var6 += var14;
						...
						drawTexuredLine(Rasterizer2D.pixels, var26, var0, var4 >> 16, var3 >> 16, var7 >> 8, var6 >> 8,
								var18, var22, var15, var28, var12, var13);
						var4 += var23;
						var3 += var11;
						var7 += var24;
				...
				while (true) {
					...
					drawTexuredLine(Rasterizer2D.pixels, var26, var0, var3 >> 16, var4 >> 16, var6 >> 8, var7 >> 8,
							var18, var22, var15, var28, var12, var13);
					var4 += var23;
					var3 += var11;
					var7 += var24;
			...
			if (var1 < Rasterizer2D.clipTop) {
						...
						while (true) {
							...
							if (var2 < 0) {
								while (true) {
									...
									drawTexuredLine(Rasterizer2D.pixels, var26, var1, var3 >> 16, var5 >> 16, var6 >> 8,
											var8 >> 8, var18, var22, var15, var28, var12, var13);
									var3 += var11;
									var5 += var23;
									var6 += var14;
							...
							drawTexuredLine(Rasterizer2D.pixels, var26, var1, var3 >> 16, var4 >> 16, var6 >> 8,
									var7 >> 8, var18, var22, var15, var28, var12, var13);
							var3 += var11;
							var4 += var16;
							var6 += var14;
					...
					while (true) {
						...
						if (var2 < 0) {
							while (true) {
								...
								drawTexuredLine(Rasterizer2D.pixels, var26, var1, var5 >> 16, var3 >> 16, var8 >> 8,
										var6 >> 8, var18, var22, var15, var28, var12, var13);
								var3 += var11;
								var5 += var23;
								var6 += var14;
						...
						drawTexuredLine(Rasterizer2D.pixels, var26, var1, var4 >> 16, var3 >> 16, var7 >> 8, var6 >> 8,
								var18, var22, var15, var28, var12, var13);
						var3 += var11;
						var4 += var16;
						var6 += var14;
				...
				if (var11 < var16) {
					...
					while (true) {
						...
						drawTexuredLine(Rasterizer2D.pixels, var26, var1, var5 >> 16, var4 >> 16, var8 >> 8, var7 >> 8,
								var18, var22, var15, var28, var12, var13);
						var5 += var11;
						var4 += var16;
						var8 += var14;
				...
				while (true) {
					...
					if (var0 < 0) {
						while (true) {
							...
							drawTexuredLine(Rasterizer2D.pixels, var26, var1, var4 >> 16, var3 >> 16, var7 >> 8,
									var6 >> 8, var18, var22, var15, var28, var12, var13);
							var3 += var23;
							var4 += var16;
							var6 += var24;
					...
					drawTexuredLine(Rasterizer2D.pixels, var26, var1, var4 >> 16, var5 >> 16, var7 >> 8, var8 >> 8,
							var18, var22, var15, var28, var12, var13);
					var5 += var11;
					var4 += var16;
					var8 += var14;
					...
					while (true) {
						...
						if (var0 < 0) {
							while (true) {
								...
								drawTexuredLine(Rasterizer2D.pixels, var26, var2, var4 >> 16, var3 >> 16, var7 >> 8,
										var6 >> 8, var18, var22, var15, var28, var12, var13);
								var4 += var16;
								var3 += var11;
								var7 += var17;
						...
						drawTexuredLine(Rasterizer2D.pixels, var26, var2, var4 >> 16, var5 >> 16, var7 >> 8, var8 >> 8,
								var18, var22, var15, var28, var12, var13);
						var4 += var16;
						var5 += var23;
						var7 += var17;
				...
				while (true) {
					...
					if (var0 < 0) {
						while (true) {
							...
							drawTexuredLine(Rasterizer2D.pixels, var26, var2, var3 >> 16, var4 >> 16, var6 >> 8,
									var7 >> 8, var18, var22, var15, var28, var12, var13);
							var4 += var16;
							var3 += var11;
							var7 += var17;
					...
					drawTexuredLine(Rasterizer2D.pixels, var26, var2, var5 >> 16, var4 >> 16, var8 >> 8, var7 >> 8,
							var18, var22, var15, var28, var12, var13);
					var4 += var16;
					var5 += var23;
					var7 += var17;
				...
				while (true) {
					...
					if (var1 < 0) {
						while (true) {
							...
							drawTexuredLine(Rasterizer2D.pixels, var26, var2, var4 >> 16, var5 >> 16, var7 >> 8,
									var8 >> 8, var18, var22, var15, var28, var12, var13);
							var4 += var11;
							var5 += var23;
							var7 += var14;
					...
					drawTexuredLine(Rasterizer2D.pixels, var26, var2, var3 >> 16, var5 >> 16, var6 >> 8, var8 >> 8,
							var18, var22, var15, var28, var12, var13);
					var3 += var16;
					var5 += var23;
					var6 += var17;
			...
			while (true) {
				...
				drawTexuredLine(Rasterizer2D.pixels, var26, var2, var5 >> 16, var3 >> 16, var8 >> 8, var6 >> 8, var18,
						var22, var15, var28, var12, var13);
				var3 += var16;
				var5 += var23;
				var6 += var17;
				var8 += var24;
	...
	private static void drawTexuredLine(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6,
