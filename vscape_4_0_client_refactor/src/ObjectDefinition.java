public final class ObjectDefinition implements bot.iface.ObjectDefinition {
	...
	public final Model modelAt(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		label251: {
			...
			Model var18 = new Model(var16.originalColors == null, Frame.isInvalid(var8),
					var2 == 0 && var8 == -1 && !var23 && !var13, var9);
			if (var8 != -1) {
				var18.createBones();
		...
		if (var10000 == null) {
			...
			if (this.contouredGround) {
				...
				var17.u = (int) (Math.sqrt((double) (var17.r * var17.r + var17.modelHeight * var17.modelHeight))
						+ 0.99D);
