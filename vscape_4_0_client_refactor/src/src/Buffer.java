...
public final class Buffer extends CacheableNode {
   ...
   final int b() {
      this.position += 3;
      return (255 & this.buf[this.position - 3] << 16) + (255 & this.buf[this.position - 2] << 8) + (255 & this.buf[this.position - 1]);
   }
   ...
   public final void a(int var1) {
      this.buf[this.position++] = (byte)(var1 + this.d.a());
   }
   ...
   public final int readTriByte() {
      this.position += 3;
      return ((this.buf[this.position - 3] & 255) << 16) + ((this.buf[this.position - 2] & 255) << 8) + (this.buf[this.position - 1] & 255);
   }

   public final int readInt() {
      this.position += 4;
      return ((this.buf[this.position - 4] & 255) << 24) + ((this.buf[this.position - 3] & 255) << 16) + ((this.buf[this.position - 2] & 255) << 8) + (this.buf[this.position - 1] & 255);
   }
   ...
   public final int D() {
      this.position += 4;
      return ((this.buf[this.position - 2] & 255) << 24) + ((this.buf[this.position - 1] & 255) << 16) + ((this.buf[this.position - 4] & 255) << 8) + (this.buf[this.position - 3] & 255);
   }

   public final int E() {
      this.position += 4;
      return ((this.buf[this.position - 3] & 255) << 24) + ((this.buf[this.position - 4] & 255) << 16) + ((this.buf[this.position - 1] & 255) << 8) + (this.buf[this.position - 2] & 255);
   }
