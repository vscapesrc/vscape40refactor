		...
		if (text != null) {
			...
			for (int var5 = 0; var5 < text.length(); ++var5) {
				...
				if ((var6 = text.charAt(var5)) != 32) {
					this.render(this.glyphs[var6], x + this.horizonalOffsets[var6], y + this.verticalOffsets[var6],
							this.glyphWidths[var6], this.glyphHeights[var6], color);
				}
		...
		if (var2 != null) {
			...
			for (int var6 = 0; var6 < var2.length(); ++var6) {
				...
				if ((var7 = var2.charAt(var6)) != 32) {
					this.render(this.glyphs[var7], var3 + this.horizonalOffsets[var7],
							var5 + this.verticalOffsets[var7]
									+ (int) (Math.sin((double) var6 / 2.0D + (double) var4 / 5.0D) * 5.0D),
							this.glyphWidths[var7], this.glyphHeights[var7], var1);
				}
	...
	public final void wave2(int var1, String var2, int var3, int var4, int var5) {
		if (var2 != null) {
			...
			for (int var6 = 0; var6 < var2.length(); ++var6) {
				char var7;
				if ((var7 = var2.charAt(var6)) != 32) {
					this.render(this.glyphs[var7],
							var1 + this.horizonalOffsets[var7]
									+ (int) (Math.sin((double) var6 / 5.0D + (double) var3 / 5.0D) * 5.0D),
							var4 + this.verticalOffsets[var7]
									+ (int) (Math.sin((double) var6 / 3.0D + (double) var3 / 5.0D) * 5.0D),
							this.glyphWidths[var7], this.glyphHeights[var7], var5);
				}
		...
		if (var2 != null) {
			...
			for (var1 = 0; var1 < var2.length(); ++var1) {
				...
				if ((var9 = var2.charAt(var1)) != 32) {
					this.render(this.glyphs[var9], var5 + this.horizonalOffsets[var9],
							var4 + this.verticalOffsets[var9]
									+ (int) (Math.sin((double) var1 / 1.5D + (double) var3) * var7),
							this.glyphWidths[var9], this.glyphHeights[var9], var6);
				}
	...
	public final void shadow(boolean var1, int var2, int var3, String var4, int var5) {
		...
		if (var4 != null) {
			...
			for (int var7 = 0; var7 < var4.length(); ++var7) {
				if (var4.charAt(var7) == 64 && var7 + 4 < var4.length() && var4.charAt(var7 + 4) == 64) {
					...
					if ((var8 = var4.charAt(var7)) != 32) {
						if (var1) {
							this.render(this.glyphs[var8], var2 + this.horizonalOffsets[var8] + 1,
									var5 + this.verticalOffsets[var8] + 1, this.glyphWidths[var8],
									this.glyphHeights[var8], 0);
						}

						this.render(this.glyphs[var8], var2 + this.horizonalOffsets[var8],
								var5 + this.verticalOffsets[var8], this.glyphWidths[var8], this.glyphHeights[var8],
								var3);
					}
			...
			if (this.strikethrough) {
				Rasterizer2D.drawHorizontal(var5 + (int) ((double) this.verticalSpace * 0.7D), 8388608, var2 - var6,
						var6);
			}
			...
			for (int var6 = 0; var6 < var3.length(); ++var6) {
				if (var3.charAt(var6) == 64 && var6 + 4 < var3.length() && var3.charAt(var6 + 4) == 64) {
					...
					if ((var7 = var3.charAt(var6)) != 32) {
						this.render(192, var1 + this.horizonalOffsets[var7] + 1, this.glyphs[var7],
								this.glyphWidths[var7], var5 + this.verticalOffsets[var7] + 1, this.glyphHeights[var7],
								0);
						this.render(var4, var1 + this.horizonalOffsets[var7], this.glyphs[var7], this.glyphWidths[var7],
								var5 + this.verticalOffsets[var7], this.glyphHeights[var7], var2);
					}
		...
		if (clipwidth > 0 && clipheight > 0) {
			...
			for (x = -x; x < 0; ++x) {
				for (var11 = -clipheight; var11 < 0; ++var11) {
					if (var13[y++] != 0) {
						var12 = var15[var14];
						var15[var14++] = (((var12 & 16711935) * var10 & -16711936)
								+ ((var12 & '\uff00') * var10 & 16711680) >> 8) + var9;
					} else {
						++var14;
					}
				}
